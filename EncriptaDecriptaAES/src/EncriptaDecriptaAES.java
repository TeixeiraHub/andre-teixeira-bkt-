...
import javax.crypto.spec.IvParameterSpec;
  ...
  public class EncriptaDecriptaAES {
         ...
         static String IV = "NonRandomIntiVec";
         static String textopuro = "encriptando com aes";
         static String chaveEncript = "0123456789abcdef";
         ...
         public static void main(String [] args) {
               ...
               try {
                      ...
                      byte[] textoencriptado = encrypt(textopuro, chaveEncript);
                      ...
                      String textodecriptado = decrypt(textoencriptado, chaveEncript);
