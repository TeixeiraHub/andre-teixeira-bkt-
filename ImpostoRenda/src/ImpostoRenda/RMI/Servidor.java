...
public class Servidor extends UnicastRemoteObject implements Servico {
	...
	public void ServCalc() throws RemoteException
	{
		...
		while(true)
		{
			...
			if(a<0)
			{
				System.out.println("Não podem ser inseridos valores negativos!" + "\nTente novamente!");
			}
			if (a <= 1868.22)
			{
				System.out.println("Você é isento do IPRF!");
			}
			if (a>=1868.23 && a<=2799.86)
			{
				System.out.println("Seu desconto de IPRF é: " +irCalcBase1(a));
			}
			if (a>=2799.87 && a<=3733.19)
			{
				System.out.println("Seu desconto de IPRF é: " +irCalcBase2(a));
			}
			if (a>=3733.20 && a<=4664.68)
			{
				System.out.println("Seu desconto de IPRF é: " +irCalcBase3(a));
			}
			else if(a>=4664.68)
			{
				System.out.println("Seu desconto de IPRF é: " +irCalcBase4(a));
			}
			break;
			}
		}
